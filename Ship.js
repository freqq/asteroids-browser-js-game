...
Ship.prototype.draw = function () {
    if (!this.destroyed) {
        ...
        if (this.hitTest()) {
            ...
            if (Game.key_65 || Game.key_68) {
                this.a += 7 * (Game.key_65 ? -1 : 1);
            }

            if (Game.key_87) {
                this.modX = Math.max(-this.max_s * VAR.d, Math.min(this.max_s * VAR.d, this.modX + Math.sin(Math.PI / 180 * this.a) * this.acc * VAR.d));
            ...
            if (Game.key_87 && this.draw_thrust) {
                Game.ctx.beginPath();
                ...
                Game.ctx.stroke();
            } else if (Game.key_87 && !this.draw_thrust) {
